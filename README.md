...
**event tracking**  
Any event can be sent with custom properties to `/v1/events` and numeri will store it with automatic metadata like
...
curl "http://localhost:3000/v1/events?eventType=page_view" \
  -H "x-secret-key: your-secret"

# filter by event type and visitor ID
curl "http://localhost:3000/v1/events?eventType=click&visitorId=123e8430-e34b-94d6-a412-34942892761" \
  -H "x-secret-key: your-secret"
```
...
- `GET /v1/events` Retrieve processed events
